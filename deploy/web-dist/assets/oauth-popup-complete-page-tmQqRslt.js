...
`;function f(e){return e.split(/[-_]/).map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(` `)}function p(){let[e]=r(),t=e.get(`requestId`),n=e.get(`oauth_status`),p=e.get(`oauth_provider`),m=e.get(`oauth_code`),h=e.get(`native`)===`1`,g=p?f(p):``,_=n===`connected`,v=_?g?`Connected to ${g}`:`Authorization Successful`:`Authorization Failed`,y=_?`You can close this popup and return to the app.`:`${g||`Service`} connection failed. Please try again.`;return(0,s.useEffect)(()=>{if(h&&t){let e=o(window.location.host);if(e){window.location.href=a(e,{requestId:t,oauthStatus:n||null,oauthProvider:p||null,oauthCode:m||null});return}}let e={type:`vellum:oauth-complete`,requestId:t,oauthStatus:n||null,oauthProvider:p||null,oauthCode:m||null};if(window.opener&&t&&window.opener.postMessage(e,window.location.origin),t)try{window.localStorage.setItem(i(t),JSON.stringify(e))}catch{}window.close()},[t,n,p,m,h]),(0,c.jsxs)(`div`,{className:`oauth-page`,children:[(0,c.jsx)(`style`,{dangerouslySetInnerHTML:{__html:d}}),(0,c.jsxs)(`div`,{className:`oauth-card`,children:[_?(0,c.jsx)(l,{}):(0,c.jsx)(u,{}),(0,c.jsx)(`h1`,{children:v}),(0,c.jsx)(`p`,{children:y}),!_&&m&&(0,c.jsxs)(`p`,{style:{marginTop:8,fontSize:11,color:`var(--oauth-text-secondary)`,opacity:.7},children:[`Error: `,m]})]})]})}export{p as OAuthPopupCompletePage};