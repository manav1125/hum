...
`;function u(e){return e.split(/[-_]/).map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(` `)}function d(e,t){if(t.opener&&t.opener.postMessage(e,t.origin),e.requestId)try{t.storage.setItem(i(e.requestId),JSON.stringify(e))}catch{}t.close()}function f(){let[e]=r(),t=e.get(`requestId`),n=e.get(`oauth_status`),i=e.get(`oauth_provider`),f=e.get(`oauth_code`),p=i?u(i):``,m=n===`connected`,h=m?p?`Connected to ${p}`:`Authorization Successful`:`Authorization Failed`,g=m?`You can close this tab and return to your assistant.`:`${p||`Service`} connection failed. You can try again from the desktop app.`,_=(0,a.useRef)(!1);return(0,a.useEffect)(()=>{_.current||(_.current=!0,d({type:`vellum:oauth-complete`,requestId:t,oauthStatus:n||null,oauthProvider:i||null,oauthCode:f||null},{opener:window.opener,origin:window.location.origin,storage:window.localStorage,close:()=>window.close()}))},[t,n,i,f]),(0,o.jsxs)(`div`,{className:`oauth-page`,children:[(0,o.jsx)(`style`,{dangerouslySetInnerHTML:{__html:l}}),(0,o.jsxs)(`div`,{className:`oauth-card`,children:[m?(0,o.jsx)(s,{}):(0,o.jsx)(c,{}),(0,o.jsx)(`h1`,{children:h}),(0,o.jsx)(`p`,{children:g}),!m&&f&&(0,o.jsxs)(`p`,{style:{marginTop:8,fontSize:11,color:`var(--oauth-text-secondary)`,opacity:.7},children:[`Error: `,f]})]})]})}export{f as OAuthCompletePage};