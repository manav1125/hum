...
| `ventureverse-apps` | 2026-08-10 | manav@brinc.io | Platform PR not yet opened (as of 2026-08-10) | Terraform entry in `../vellum-assistant-platform/terraform/launchdarkly.tf` (or equivalent) with `defaultEnabled: false` provisioning the `ventureverse-apps` assistant flag (embedded VentureVerse app store surface) before it is flipped on anywhere hosted. |
