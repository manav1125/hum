...
- `navigate_settings_tab` - Open the Cue settings panel to the Voice tab
...
3. Tell the user: "I've opened System Settings to the Microphone section. Please toggle **Cue Assistant** on, then come back here."
...
5. **App focus** - PTT may not work when Cue is not the frontmost app or if another app has captured the key.
