...
- **403 Forbidden**: The integration doesn't have access to the requested page or database. Remind the user that they need to share the page/database with the "Cue Assistant" integration in Notion (via the Share menu → "Add connections").
