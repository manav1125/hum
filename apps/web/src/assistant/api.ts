...
export async function getAssistant(
  ...
  // Self-host (Cue gateway): there is no platform assistants listing to fall
  // through to — that request can only 401, and callers (e.g. Settings →
  // Integrations) then wrongly render "No assistant found. Hatch an
  // assistant." Resolve from the already-hydrated resolved-assistants store.
  if (isSelfHostMode()) {
