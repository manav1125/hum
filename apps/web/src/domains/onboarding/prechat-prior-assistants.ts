...
export const PRECHAT_PRIOR_ASSISTANTS: PreChatPriorAssistantItem[] = [
  {
    id: "chatgpt",
    label: "ChatGPT",
    logoSrc: publicAsset("/images/prior-assistants/chatgpt.svg"),
  },
  {
    id: "claude",
    label: "Claude",
    logoSrc: publicAsset("/images/prior-assistants/claude.svg"),
  },
  {
    id: "openclaw",
    label: "OpenClaw",
    logoSrc: publicAsset("/images/prior-assistants/openclaw.png"),
  },
  {
    id: "hermes",
    label: "Hermes",
    logoSrc: publicAsset("/images/prior-assistants/hermes.png"),
  },
  {
    id: "manus",
    label: "Manus",
    logoSrc: publicAsset("/images/prior-assistants/manus.svg"),
  },
  {
    id: "gemini",
    label: "Gemini",
    logoSrc: publicAsset("/images/prior-assistants/gemini.svg"),
  },
  {
    id: "copilot",
    label: "Copilot",
    logoSrc: publicAsset("/images/prior-assistants/copilot.svg"),
  },
];
