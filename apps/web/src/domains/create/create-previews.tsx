    ...
    <Frame>
      ...
      {variant === "logo" ? (
        ...
        <>
          {[40, 122, 204].map((x, i) => (
            <g key={x}>
              ...
              />
              {i === 0 && (
                <circle cx={x + 38} cy="84" r="22" fill={`url(#${id})`} />
              )}
              {i === 1 && (
                <rect
                  x={x + 18}
              ...
              {i === 2 && (
                <path
                  d={`M${x + 18} 104 L${x + 38} 62 L${x + 58} 104 Z`}
                  fill={C.accent}
                />
              )}
            </g>
        ...
        <>
          ...
          <path
            d="M38 122 L120 92 L168 110 L220 86 L282 112 L282 138 L38 138 Z"
            fill="#ffffff"
            opacity="0.18"
          />
          {variant === "social" && (
...
function CanvasPreview({ variant }: { variant?: string }) {
  return (
    <Frame>
      ...
      <path
        d="M30 130 L72 102 L100 118 L146 96 L146 140 L30 140 Z"
        fill="#ffffff"
        opacity="0.2"
      />
      ...
      {variant === "remove-bg" ? (
        ...
        <>
          ...
          <path
            d="M174 130 L216 102 L244 118 L290 96 L290 140 L174 140 Z"
            fill={C.accent}
            opacity="0.5"
          />
        </>
      ...
      />
      <path
        d="M155 80 l-3 4 l3 4 M163 80 l3 4 l-3 4"
        fill="none"
        stroke={C.accent}
        strokeWidth="1.5"
        strokeLinecap="round"
    ...
    <Frame>
      ...
      {rows.map((_, i) => {
        ...
        return (
          <g key={y}>
            {i > 0 && (
              <line x1="22" y1={y - 6} x2="298" y2={y - 6} stroke={C.line} />
            )}
            <circle
              cx="40"
              cy={y + 2}
              r="8"
              fill={i % 2 ? C.accentViolet : C.accent}
              opacity="0.85"
            />
            <rect
              x="58"
