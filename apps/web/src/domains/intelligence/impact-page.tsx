...
export function ImpactPage() {
  ...
  // True week-over-week: the daemon compares this window against the prior
  // equal-length window and returns `changePercent` (null on a first week with
  // no prior activity, so we omit the badge rather than show a bogus +100%).
              ...
              {changePercent !== null && changePercent !== 0 && (
                <div
                  style={{
                    ...
                    fontSize: 10,
                    letterSpacing: ".04em",
                    color: changePercent > 0 ? "#6FCF97" : "#E0B15E",
                  }}
                >
