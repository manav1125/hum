/**
 * Path-containment predicate shared by the memory modules that gate
 * filesystem access to a workspace-owned root (the prompt-override loaders in
 * `v2/prompts/` and the context-search sources).
 *
