...
// One factory serves both connections: the production module reads jobs
// off getMemoryDb() (memory_jobs relocated by migration 328) and
// conversations off getDb(); the select() heuristics below key on column
// shape, so the same stub answers both correctly.
