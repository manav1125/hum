...
// The live capability derivation lives in `capabilities/capability-snapshot.ts`
// so the conversational agent reads the SAME snapshot this assessor does
// (it previously discovered itself by shelling out to `assistant --help`).
// Re-exported here because the assessor's callers and tests import it from
// this module.
export {
...
import type { CapabilitySnapshot } from "../capabilities/capability-snapshot.js";
