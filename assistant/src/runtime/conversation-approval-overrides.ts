 ...
 *
 * Expiry NEVER auto-allows anything: an expired override simply disappears,
 * returning the conversation to the normal ask-per-action flow.
 *
 * Recovered from upstream (originally e05896063f, renamed in c16e4b013d,
 * last intact at 46d64df40d^).
 */
...
export const DEFAULT_TIMED_DURATION_MS = 10 * 60 * 1000; // 10 minutes
