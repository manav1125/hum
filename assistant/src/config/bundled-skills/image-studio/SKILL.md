...
- Replicate is a DIRECT api.replicate.com integration. Never offer a Composio/OAuth "Connect Replicate" flow, and on a self-hosted deployment never tell the user to "log in to Cue" to fix image generation.
