...
export const MAX_TOKENS_THINKING_ONLY_NUDGE_TEXT =
  "<system_notice>Your previous response spent its entire output budget inside thinking and emitted nothing: no tool call, no text. Do not resume planning and do not restate the plan. Produce the tool call or the reply text now, composing any remaining content directly in the output instead of in thought.</system_notice>";
