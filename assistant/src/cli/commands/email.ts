  ...
  registerCommand(program, {
    ...
    build: (email) => {
      ...
      email.addHelpText(
        "after",
        `
Set up and manage this assistant's native email address on the Cue
...
Registers a new email address on the Cue platform for the current
...
Cue runtime proxy. The "from" address is automatically resolved
