...
OAuth providers may support up to two modes – "managed" and "your-own".
  managed:
    Requires a Cue Platform account. For providers that support it, managed mode offloads the burden of needing to create and register an oauth app.
    Cue Platform manages oauth token management and refresh and proxies requests to the provier.
  you-own:
    Provides ultimate control and removes dependency on Cue Platform, but requires that you set up your own oauth app and register it
