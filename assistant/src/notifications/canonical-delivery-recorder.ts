 ...
 * channel-native message id (e.g. a Telegram message id) here is what lets a
 * delivered card be addressed back to its request later — to withdraw it in
 * place when the request resolves (`approvals/guardian-card-withdrawal.ts`).
 */
...
): ReturnType<typeof createCanonicalGuardianDelivery> {
