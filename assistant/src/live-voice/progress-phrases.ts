...
// running tools or tasks, at most 8 words per phrase. English keeps the
// design-owned Cue wording; the other rosters are upstream's translations.
...
// state, not about the work, and it has to be true every time (design v37
// §W2, binding copy — Cue register, chosen over upstream's wording). Kept
// in the shape of the progress phrases it displaces (short, neutral, no
// claim about tools).
export const APPROVAL_PENDING_PHRASE =
  "That one needs your okay — take a look.";
...
// running tools or tasks. English keeps the Cue-register copy above.
