...
const PROVIDER_MODEL_INTENTS: Record<string, Record<ModelIntent, string>> = {
  anthropic: {
    ...
    // Fable 5 is suspended — route the quality tier to Opus 4.8, the current
    // top model, so complexity-routed "complex" queries don't hit a dead model.
  ...
  openrouter: {
    ...
    // Fable 5 is suspended — use Opus for the quality tier.
