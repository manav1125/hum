...
// Re-exported for existing importers of the client's error surface
// (e.g. the adapter and credential post-connect hooks).
export { SlackApiError } from "./web-api-transport.js";
