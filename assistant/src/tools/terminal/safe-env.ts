...
export const SAFE_ENV_VARS = [
  ...
  "VELLUM_MEMORY_RETRIEVAL_BUDGET_MS",
  "CUE_DISABLE_LOOP_LAG_MONITOR",
  "CUE_DISABLE_MISSION_ORCHESTRATOR",
  "CUE_DISABLE_CONTACT_MEMORY",
  "CUE_DISABLE_BRAND_EXTRACT",
  "CUE_LOOP_LAG_WARN_MS",
  "CUE_EMBED_ONNX_THREADS",
  "CUE_EMBED_WORKER_NICENESS",
  "CUE_LOG_FULL_LLM_PAYLOADS",
  "CUE_MANAGED",
  "CUE_OPENROUTER_MODEL",
  "CUE_OPENROUTER_FLASH_MODEL",
  "CUE_OPENROUTER_VISION_MODEL",
