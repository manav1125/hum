...
- **Who did what** — 38 you / 61 Cue = 62% share, **real spend**, and **acts you reversed** (the two figures that make it credible)
...
**Schema:** reasoning trace stored per generated artefact.
...
- **Contrast, both themes. Use these muted tokens:**
  ...
  - light-theme state colours: amber `#B4770F`, green `#277E41`, red `#C24E42`, violet `#534AB7`, teal `#0E8C8C`
  - **Honest scoping:** 4.5:1 is the target and is met for all *neutral* body and secondary text. The sanctioned accent/state palette measures **3.4–4.1:1** at small sizes (`#3D6EE8` links, `#B4770F` microlabels, `#0E8C8C`, white glyphs on agent chips). That is a knowing brand trade-off carried since v2, and it is acceptable **only** where the text is redundant with a glyph or is a repeated microlabel. Any accent-coloured text that carries unique, non-redundant information must be sized ≥16px or moved to a neutral token.
